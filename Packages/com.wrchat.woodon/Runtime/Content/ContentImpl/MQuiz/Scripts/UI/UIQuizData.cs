...
namespace WRC.Woodon
{
    ...
    public class UIQuizData : UIMDataContainer
    {
        ...
        public virtual void UpdateUI()
        {
            ...
            bool nowWaiting = quizManager.ContentState == (int)QuizGameState.Wait;
        ...
        public override void UpdateUI(MDataContainer mData)
        {
            ...
            bool checkAnswer = quizManager.ContentState == (int)QuizGameState.CheckAnswer;
            foreach (CanvasGroup answerCanvasGroup in answerCanvasGroups)
                SetCanvasGroupActive(answerCanvasGroup, checkAnswer);

            bool explain = quizManager.ContentState >= (int)QuizGameState.Explaining;
